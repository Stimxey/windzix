...
exports.run = (client, message, args) => {
  ...
  const embed = new Discord.RichEmbed()
    ...
    .setFooter(`Encuesta creada ${message.author.username}`, message.author.avatarURL);

  if (args1 === null || args1.length < 3 || args1.length > 10) {
    message.reply("formato de encuesta incorrecto - `mpoll <pregunta>|<respuesta 1>|...|<repuesta 9>`");
  } else {
    message.channel.send('❓ **' + question + '**', {
      ...
      var final = "**¡La encuesta ha terminado!**\n\n"
